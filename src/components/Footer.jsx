...
const Footer1 = () => {
    return (
      ...
      <section className="footer-social-section flex-rw">
          ...
          <Link to="https://www.facebook.com/rigolaz" target="_blank" title="Facebook" className="socials-item">
            <i className="fab fa-facebook-f facebook"></i>
          </Link>
          <Link to="https://twitter.com/etralis0" target="_blank" title="Twitter" className="socials-item">
            <i className="fab fa-twitter twitter"></i>
          </Link>
          <Link to="https://www.linkedin.com/company/etralis" target="_blank" title="Linkedin" className="socials-item">
          <i className="fab fa-linkedin linkedin"></i>
          </Link>
          <Link to="https://www.youtube.com/channel/UCTS7-okshzwjoxV5xsogziQ" target="_blank" title="YouTube" className="socials-item">
            <i className="fab fa-youtube youtube"></i>
          </Link>
          <Link to="https://www.instagram.com/rigolaz" target="_blank" title="Instagram" className="socials-item">
