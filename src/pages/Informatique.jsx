    ...
    return (
		...
		<div className='intro' style={{backgroundImage:`linear-gradient(rgba(0, 0, 0, 0.4), rgba(0, 0, 0, 0.2)), url("https://res.cloudinary.com/do8lyndou/image/upload/v1670596669/Informatic_e4ns0a.jpg")`}} >
			...
			<div className="body">
				...
				<h2>Technique de support</h2><img src="https://res.cloudinary.com/do8lyndou/image/upload/v1674226787/photo-1523553374578-aba5fa21a345_uwtcpk.jpg" alt="bedroom" />
				<p>Le technicien de support informatique assure la maintenance de tout type de matériel informatique tels que <strong>ordinateurs</strong>, et des <strong>périphériques</strong> comme les imprimantes, disque dur externe, etc... Il s'occupe aussi de la sécurité de l'ensemble des appareils informatiques et leur bon fonctionnement en installant les différents logiciels d'exploitation et des applications. Il s'assure aussi de la sécurité de l'ensemble des logiciels en installant un logiciel antivirus adéquat.</p>
